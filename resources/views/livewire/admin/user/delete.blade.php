            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div>
                        ...
                        @if ($deleteUserId !== auth()->id())
                            <span class="fw-bold">{{ $deleteUserName }}</span>?
                        @else
                            <span class="text-danger">Anda tidak dapat menghapus akun sendiri.</span>
                        @endif
                    </div>
                    <div class="pt-3">Pilih <b>Ya, Hapus</b> untuk melanjutkan</div>
                </div>
                <div class="modal-footer">
                    <button wire:click="cancelDelete" type="button" class="btn btn-link link-secondary me-auto"
