                                    ...
                                    <button wire:loading.attr="disabled" wire:click="add" type="button"
                                        ...
                                        <span wire:loading.remove wire:target="add">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="icon icon-tabler icons-tabler-outline icon-tabler-key-plus">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                <path
                                                    d="M16 10q-1 -1 -2.5 -1t-2.5 1l-4 4a2 2 0 1 0 3 3l4 -4q1 -1 1 -2.5t-1 -2.5z" />
                                ...
                                <tbody>
                                    @forelse ($permissions as $permission)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-purple-lt">{{ $permission->roles->count() }}
                                                    roles</span>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <button wire:click="edit('{{ $permission->id }}')"
                                                    ...
                                                    <span wire:loading.remove
                                                        wire:target="edit('{{ $permission->id }}')">
                                                    ...
                                                    <span wire:loading wire:target="edit('{{ $permission->id }}')">
                                                        <span class="spinner-border spinner-border-sm" role="status"
                                                            aria-hidden="true"></span>
                                                ...
                                                <button wire:click="delete('{{ $permission->id }}')"
                                                    ...
                                                    <span wire:loading.remove
                                                        wire:target="delete('{{ $permission->id }}')">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
