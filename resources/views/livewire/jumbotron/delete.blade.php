    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <div class="modal-title text-danger">Apakah anda yakin ingin menghapus Data Jumbotron atas
                    nama:</div>
                <div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link link-secondary me-auto"
                    wire:click="$dispatch('closeDeleteModal')">Batal</button>
                <button wire:loading.attr="disabled" wire:click="destroyJumbo" type="button" class="btn btn-danger">
                    <span wire:loading.remove wire:target="destroyJumbo">
                        Ya, Hapus
                    </span>
                    <span wire:loading wire:target="destroyJumbo">
