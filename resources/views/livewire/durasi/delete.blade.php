    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <div class="modal-title text-danger">Apakah Anda yakin ingin menghapus durasi untuk masjid milik
                    {{ $deleteDurasiName }}? Tindakan ini tidak dapat dibatalkan.
                </div>
                <div>
            ...
            <div class="modal-footer">
                ...
                <button wire:loading.attr="disabled" wire:click="destroyDurasi" type="button" class="btn btn-danger">
                    <span wire:loading.remove wire:target="destroyDurasi">
                        Ya, Hapus
                    </span>
                    <span wire:loading wire:target="destroyDurasi">
