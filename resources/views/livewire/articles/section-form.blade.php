            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-3 @error('title') is-invalid @enderror"
                            wire:model="title" placeholder="Masukkan judul berita">
                        @error('title')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3 @error('article_category_id') is-invalid @enderror"
                            wire:model="article_category_id">
