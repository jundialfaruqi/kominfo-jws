    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <div class="modal-title text-danger">Apakah anda yakin ingin menghapus Tema:</div>
                <div>
            ...
            <div class="modal-footer">
                ...
                <button wire:loading.attr="disabled" wire:click="destroyTheme" type="button" class="btn btn-danger">
                    <span wire:loading.remove wire:target="destroyTheme">
                        Ya, Hapus
                    </span>
                    <span wire:loading wire:target="destroyTheme">
