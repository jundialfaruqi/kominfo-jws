                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row g-2 mb-3">
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan3"
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan4"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan5"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan6"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                ...
                                                <div class="row g-2 mb-3">
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan15"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                ...
                                                <div class="row g-2 mb-3">
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan7"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan8"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan9"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan10"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan11"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
                                                    ...
                                                    <div class="col-md-4 mb-2 px-2">
                                                        ...
                                                        @endif
                                                        <div wire:loading wire:target="adzan12"
                                                            class="mt-2 text-center">
                                                            <span class="spinner-border spinner-border-sm"
                                                                role="status" aria-hidden="true"></span>
                                                            <span class="small">Mengupload...</span>
