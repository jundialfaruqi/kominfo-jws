        ...
        <div class="card card-sm rounded-4 border-0 shadow-sm bg-body">
            <div class="card-body py-2">
                <div class="d-flex align-items-center justify-content-between gap-1">
                    <span class="me-2 avatar bg-dark shadow-sm text-white rounded-circle">{{ $item['index'] }}</span>
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center justify-content-between gap-2">
                            ...
                            <span
                                class="text-secondary small">{{ $item['model']->created_at->format('d M Y H:i') }}</span>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <span class="text-secondary small">{{ $item['model']->guard_name }}</span>
                            <span class="badge bg-purple-lt">{{ $item['model']->roles->count() }}
                                roles</span>
                        </div>
                    </div>
                    <div class="ms-2">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="#" class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#editModal" wire:click="edit('{{ $item['model']->id }}')">
                                ...
                                <a href="#" class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" wire:click="delete('{{ $item['model']->id }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
