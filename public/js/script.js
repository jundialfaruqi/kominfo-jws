...
//     // Function to clear all Adzan states
...
//     // Cek pergantian hari setiap detik, bukan setiap menit
//     function checkDayChange() {
//         const now = getCurrentTimeFromServer();
//         // Perbaiki format tanggal dengan menambahkan 1 pada bulan
//         const currentDate = `${now.getFullYear()}-${now.getMonth() + 1}-${now.getDate()}`;
//         const storedDate = localStorage.getItem('lastCheckedDate');
//         console.log('Checking day change...', currentDate, storedDate);
//         if (currentDate !== storedDate) {
//             // Clear semua localStorage terkait adzan
//             clearAllAdzanStates();
//             localStorage.setItem('lastCheckedDate', currentDate);
//             location.reload();
//         }
...
//         // Jika waktu sholat sudah lewat lebih dari 2 menit, gunakan waktu sekarang
//         const timeDiff = serverTime - prayerTime;
//         if (timeDiff > 0 && timeDiff < 2 * 60 * 1000) {
//             return serverTime.getTime() - 10000; // Mulai 10 detik yang lalu
//         }
...
//         // Validasi tanggal jadwal dengan tanggal server
//         const now = getCurrentTimeFromServer();
//         const currentDate = now.getDate();
//         const serverMonth = now.getMonth() + 1;
//         const serverYear = now.getFullYear();
        
//         const scheduleMonth = parseInt(document.getElementById('current-month').value);
//         const scheduleYear = parseInt(document.getElementById('current-year').value);
        
//         // Jika bulan atau tahun jadwal tidak sama dengan server, reload halaman
...
//             // Cek apakah waktu saat ini tepat sama dengan waktu sholat atau 1 menit setelahnya
...
//     // Cek pergantian hari setiap menit
//     checkDayChange();
