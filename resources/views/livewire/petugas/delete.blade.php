    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <div class="modal-title text-danger">Apakah anda yakin ingin menghapus Data Petugas Jum'at atas Nama:
                </div>
                <div>
            ...
            <div class="modal-footer">
                ...
                <button wire:loading.attr="disabled" wire:click="destroyPetugas" type="button" class="btn btn-danger">
                    <span wire:loading.remove wire:target="destroyPetugas">
                        Ya, Hapus
                    </span>
                    <span wire:loading wire:target="destroyPetugas">
