                ...
                <div wire:loading.remove wire:target="edit">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input wire:model="password" type="password" id="password-edit"
                            ...
                            <button type="button" class="btn btn-outline-secondary rounded-end-3"
                                onclick="togglePassword('password-edit', this)">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input wire:model="password_confirmation" type="password" id="password-confirmation-edit"
                                class="form-control rounded-start-3 @error('password_confirmation') is-invalid @enderror"
                                placeholder="Masukkan Konfirmasi Password">
                            <button type="button" class="btn btn-outline-secondary rounded-end-3"
                                onclick="togglePassword('password-confirmation-edit', this)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="icon-eye">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
