    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button wire:loading.attr="disabled" wire:click="destroyProfile" type="button" class="btn btn-danger">
                    <span wire:loading.remove wire:target="destroyProfile">
                        Ya, Hapus
                    </span>
                    <span wire:loading wire:target="destroyProfile">
